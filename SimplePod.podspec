...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yogeshbh/SimplePod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yogeshbh' => 'yogeshbh@cybage.com' }
  s.source           = { :git => 'https://github.com/yogeshbh/SimplePod.git', :tag => s.version.to_s }
